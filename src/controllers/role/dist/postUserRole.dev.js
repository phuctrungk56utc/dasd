...
var postUserRole = function postUserRole(req, res) {
  var queryRoot, lengthList, i, element, queryInsert, _i;

  return regeneratorRuntime.async(function postUserRole$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          queryRoot = "DELETE FROM prm.\"userRole\" WHERE \"userId\" IN (";
        ...
        case 7:
          ...
          queryInsert = "INSERT INTO prm.\"userRole\"(\n                \"RoleID\", \"userId\")\n                VALUES";
          ...
          for (_i in req.body.params.params.data) {
            ...
            if (lengthList === Number(_i) + 1) {
              element = "('".concat(req.body.params.params.data[_i].RoleID, "','").concat(req.body.params.params.data[_i].userId, "')");
            } else {
              element = "('".concat(req.body.params.params.data[_i].RoleID, "','").concat(req.body.params.params.data[_i].userId, "'),");
            }
